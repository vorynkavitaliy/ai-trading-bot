...
▸ <code>моноширинный</code> — ВСЕ цены/уровни/тикеры/перцентили/проценты (<code>62 700</code>,
  <code>47-й</code>, <code>DXY 104.2</code>): цифры выравниваются, читается как приборная панель.
▸ <b><i>жирный курсив</i></b> — ОДИН раз на сообщение, для самого важного вывода.
▸ <pre>…</pre> — выровненный дашборд; <blockquote>…</blockquote> — мнение/вердикт; источники в
...
Формат — см. блок выше. Verify `wc -m` ≤4096, send EXACTLY ONCE:

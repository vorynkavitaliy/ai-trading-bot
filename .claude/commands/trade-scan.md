---
description: "Claude-driven trading cycle v2. Regime-gated Playbook A+B on 10-pair universe (BTC/ETH/SOL/BNB/OP/NEAR/AVAX/SUI/XLM/TAO). Run via /loop 5m /trade-scan all."
...
6. `vault/Thesis/{SYMBOL}.md` for each active pair: BTC, ETH, SOL, BNB, OP, NEAR, AVAX, SUI — per-pair state
...
- Funding rate >+0.05% or <−0.05% on any pair in universe (BTC/ETH/SOL/BNB/OP/NEAR/AVAX/SUI)
